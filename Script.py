...
😎 𝖯𝗈𝗐𝖾𝗋𝖾𝖽 𝖻𝗒 @adinannissar"""

    ABOUT_TXT = """<b>○ 𝖬𝗒 𝖭𝖺𝗆𝖾: {}
○ 𝖢𝗋𝖾𝖺𝗍𝗈𝗋 : <a href='https://t.me/adinannissar'>ADINAN</a>
○ 𝖫𝖺𝗇𝗀𝗎𝖺𝗀𝖾 : 𝖯𝗒𝗍𝗁𝗈𝗇 𝟥 
...
- Source - https://github.com/tele-gram-bot/newautobot""" #please don't change repo link give credit :)
...
Message <b>: {}</b>"""
    ...
    CAPTION = """
📂 <em>File Name</em>: <code>ADINAN|{file_name}</code> 

🖇 <em>File Size</em>: <code>{file_size}</code> 

❤️‍🔥 </i>Join</i> [Movies Flix](https://t.me/netflixOxG)  

🖥 <i>Requests</i> - ||@selena_X_autofilterbot|| """
...
🎊 𝖯𝗈𝗐𝖾𝗋𝖾𝖽 𝖡𝗒 [[ADINAN]](t.me/adinannissar)"""
...
📅 𝖣𝖺𝗍𝖾 : <code>{}</code>
⏰ 𝖳𝗂𝗆𝖾 : <code>{}</code>
🌐 𝖳𝗂𝗆𝖾𝗓𝗈𝗇𝖾 : <code>Asia/Kerala</code>
